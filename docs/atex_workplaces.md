...
- **Полноэкранный пульт (#4798):** пульт занимает рабочую область целиком — левого меню на
  ...
  страницы (`.navbar-workspace`) подписью «{имя планшета} · {дата} · {втулкорез}»
  (`core.workspaceTitleParts`). **День — всегда текущий календарный**, выбора дня нет и
  выбранный день не запоминается. Втулкорез — кнопка в шапке: открывает список справочника
