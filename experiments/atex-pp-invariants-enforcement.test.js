...
var DECLARED_MODES = {
    ...
    FIXED_NO_OVERTAKE:'audit',   // #4542: очерёдность чинится построением плана, а не отказом от записи
    ...
    FIT_IN_SHIFT_NO_SPLIT: 'audit',   // разрыв — свойство ВСЕЙ раскладки (#4650); чинится резервом целостности в упаковщике, не отказом от записи
    SUPPLY_CONSERVED: 'audit'    // #4536: недостача — итог ВСЕГО плана, отказом от операции её не добрать
};
