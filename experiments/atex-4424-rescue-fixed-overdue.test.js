...
(function () {
    ...
    // #4436: замороженный день планировщик не трогает вовсе — задание даже не попадает в набор
    // записи (обновления нет), значит его «Дата план» остаётся ровно такой, какой была.
    assertEqual(res['frz'], undefined, 'задание замороженного дня не переписывается (#4436)');
})();
