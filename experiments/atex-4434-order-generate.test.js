...
(function () {
    ...
    // #4436: замороженный день исключён из планирования целиком — его заданиям обновлений нет вовсе,
    // значит их «Дата план» осталась прежней (день 0).
    assertEqual([res.days['a'], res.days['b']], [undefined, undefined],
        'п.1: задания замороженного дня 0 не переписаны — остались в нём');
    assert(res.days['c'] == null || res.days['c'].day !== 0, 'п.1: задание другого дня не въехало в замороженный день 0');
})();
